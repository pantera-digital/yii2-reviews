...
class m181109_134745_init_reviews extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{%review}}', [
            ...
            'model_id'    => $this->integer()->unsigned()->notNull()->comment('Идентификатор модели к которой оставлен отзыв'),
            'status'      => $this->tinyInteger()->unsigned()->notNull()->defaultValue(0)->comment('Статус публикации отзыва'),
        ...
        $this->createTable('{{%review_metric_types}}', [
            ...
            'type' => $this->integer()->notNull()->comment('Тип метрики, которую заполняет пользователь (оценка или текст)'),
        ]);
        ...
        $this->addForeignKey('fk-review-metric-review', '{{%review_metric}}','review_id','{{%review}}','id');
    }
    ...
    {
        echo "m181109_134745_init_reviews cannot be reverted.\n";
